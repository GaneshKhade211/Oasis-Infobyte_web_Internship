...
rainy.addEventListener('click', () => {
    if (!rainy.classList.contains('play')) {
        ...
        rainy.src = "https://raw.githubusercontent.com/devvsakib/oasis-infobyte/dd8e8d86724cabace5eae561b67c9fdba2f78ffe/Task3/pause-solid.svg"
        ...
        rainy.src = "https://raw.githubusercontent.com/devvsakib/oasis-infobyte/dd8e8d86724cabace5eae561b67c9fdba2f78ffe/Task3/play-solid.svg"
        relaxingSound.src = "";
        relaxingSound.pause()
        console.log("Paused");
    }
